...
import tn.esprit.spring.services.FournisseurServiceImpl;
...
public class FournisseurServiceTest {
   ...
   FournisseurServiceImpl fournisseurService;
    ...
    Fournisseur f1 = new Fournisseur(12L, "Code Safa","Libelle HLK");
    Fournisseur f2 = new Fournisseur(22L, "Code Safa2","Libelle HLK2");

    List<Fournisseur> listFournisseurs = new ArrayList<Fournisseur>() {
        {
            add(f1);
            add(new Fournisseur(10L, "code 1","libelle 1"));
            add(new Fournisseur(20L, "code 2","libelle 2"));
        }
    };
